...
<section class="page page-profile">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal ng-pristine ng-valid" name="edicomi" id="edicomi" action="<?=$baseurl?>admin/profes/guardar/<?=$profesor->id?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="id_entidad" id="id_entidad" >
                                ...
                                ?>
                                        <option value="<?=$entidad->id?>"  <? if($entidad->id == $profesor->id_entidad){echo 'selected';} ?>><?=$entidad->descripcion?></option>
                                <? } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="mail" name="mail" value="<?=$profesor->mail?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <button type="button" data-accion="edit_comi" id="btn_profesor" class="btn btn-success">Guardar Cambios</button> <i id="reg-cargando" class="fa fa-spinner fa-spin hidden"></i>
            </form>
        </div>
    </div>
</section>                    
