  <div class="page page-table" data-ng-controller="tableCtrl">
    <div class="panel panel-default table-dynamic">
      <div class="panel-heading"><strong><span class="fa fa-user"></span> RESULTADOS DE LA BUSQUEDA</strong></div>
        ...
        <table class="table table-bordered table-striped table-responsive" id="clientes">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Futbol, Karate</td>
                    <td><a href="<?=base_url()?>admin/socios/editar">Editar</a> | <a href="<?=base_url()?>admin/socios/resumen">Ver Resumen</a></td>
                </tr>  
