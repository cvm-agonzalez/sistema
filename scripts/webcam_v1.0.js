...
var Webcam = {
	...
	attach: function(elem) {
		...
		if (this.userMedia) {
			...
			function(err) {
				return self.dispatch('error', "Deberá permitir que el navegador utilize la webcam.");
			});
		}
		else {
			// flash fallback
	...
	snap: function() {
		...
		if (!this.loaded) return this.dispatch('error', "La webcam no pudo cargar correctamente.");
